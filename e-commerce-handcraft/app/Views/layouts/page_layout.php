                        ...
                        <ul class="mini-cart__list">
                            ...
                            ?>
                                <li class="mini-cart__product">
                                    <a href="<?= route_to('delete_cart', $value->id_keranjang) ?>" class="mini-cart__product-remove">
                                        <i class="la la-remove"></i>
                                    </a>
                                    <div class="mini-cart__product-image">
                                        <img src="https://dash.sandy.sivia.id/assets/img/produk/<?= $value->foto ?>" alt="products">
                                    </div>
                                    <div class="mini-cart__product-content">
                                        <a class="mini-cart__product-title" href="#"><?= $value->nama_produk ?></a>
