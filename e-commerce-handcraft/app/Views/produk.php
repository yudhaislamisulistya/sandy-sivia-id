                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    <?php foreach ($data as $key => $value) { ?>
                                        <tr>
                                            <td><img style="border-radius: 20px" height="300" src="https://dash.sandy.sivia.id/assets/img/produk/<?= $value->foto ?>" alt=""></td>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    <?php foreach ($data_jasa as $key => $value) { ?>
                                        <tr>
                                            <td><img style="border-radius: 20px" height="300" src="https://dash.sandy.sivia.id/assets/img/jasa/<?= $value->foto ?>" alt=""></td>
